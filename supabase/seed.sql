...
insert into public.product_variants (product_id, color_name, color_hex, size_36, size_38, size_40, size_42, size_44)
values
  ('a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'T.Blue / Sh No.02', '#38bdf8', 1, 2, 3, 2, 3),
  ('a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'Orange / Sh No.03', '#fb923c', 1, 1, 0, 1, 2),
...
insert into public.product_variants (product_id, color_name, color_hex, size_36, size_38, size_40, size_42, size_44)
values
  ('b2c3d4e5-f6a7-4b5c-9d0e-1f2a3b4c5d6e', 'Sand Beige / Shade No.01', '#d6c7b2', 3, 5, 6, 2, 1),
